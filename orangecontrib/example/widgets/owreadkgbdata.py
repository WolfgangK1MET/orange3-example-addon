# -*- coding: utf-8 -*-
"""
Created on Tue Apr 21 12:01:54 2020
...
from AnyQt.QtWidgets import QStyle, QComboBox, QMessageBox, QGridLayout, QLabel, \
...
from Orange.widgets.utils.filedialogs import RecentPath, RecentPathsWComboMixin, open_filename_dialog
...
class OWReadKGBData(OWWidget, RecentPathsWComboMixin):
    # Widget needs a name, or it is considered an abstract widget
    # and not shown in the menu.
    name = "Read KGB Data"
    description = "A widget for reading data from KGB csv files"
    icon = "icons/File.svg"
    priority = 10
    #category = "Data"
    ...
    class Outputs:
        ...
        dataK1 = Output("Data K1", Orange.data.Table)
        dataK2 = Output("Data K2", Orange.data.Table)
        dataS1 = Output("Data S1", Orange.data.Table)
        dataS4 = Output("Data S4", Orange.data.Table)
...
if __name__ == "__main__":
    ...
    WidgetPreview(OWReadKGBData).run()