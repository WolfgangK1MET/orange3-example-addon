...
class OracleBackend(Backend):
    ...
    def list_tables_query(self, schema=None):
        ...
        return "SELECT OWNER,TABLE_NAME, COLUMN_NAME, COMMENTS from All_COL_COMMENTS WHERE COLUMN_NAME!='DATEI' AND COLUMN_NAME NOT LIKE '%ZEIT' AND (OWNER LIKE '%' OR OWNER LIKE 'KOK%' OR OWNER LIKE 'RSA%' OR OWNER LIKE 'ABW%') ORDER BY TABLE_NAME"
